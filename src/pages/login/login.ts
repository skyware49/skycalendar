...
export class LoginPage {
  ...
  constructor(public navCtrl: NavController, public toastCtrl: ToastController, private http: Http, public menuCtrl: MenuController) {
  ...
  doLogin() {
    ...
    var result;
    var userInfo;
    var addr = "http://1.221.205.250:8088/mobile/LoginAction";
    /*let body = {
      userId : userId,
      userPw : userPw
    };*/
